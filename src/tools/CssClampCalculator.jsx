          ...
          <div className="tool-panel">
            ...
            <div
              style={{
                ...
                borderRadius: 8,
                fontSize: `clamp(${minSize / 16}rem, ${(minSize - ((maxSize - minSize) / (maxWidth - minWidth)) * minWidth).toFixed(4)}px + ${(((maxSize - minSize) / (maxWidth - minWidth)) * 100).toFixed(4)}vw, ${maxSize / 16}rem)`,
              }}
            >
              Fluid text sample
            </div>
