...
// Plain btoa/atob only handle Latin1 (single-byte) characters and throw or
// corrupt output on real UTF-8 text (emoji, accented characters, non-Latin
// scripts) - encode/decode through UTF-8 bytes explicitly so this actually
// works on any text, not just ASCII.
...
export default function Base64Tool() {
  ...
  const output = (() => {
    ...
    try {
      ...
      setError(mode === 'encode' ? 'Unable to encode this input.' : 'Invalid Base64 input.');
      return '';
    }
  })();
