        ...
        <div className="tool-page">
            ...
            {linked ? (
                <div className="tool-controls">
                    <label>
                        ...
                        <input type="range" min={0} max={150} value={linkedRadius} onChange={(e) => updateLinked(Number(e.target.value))} />
                    </label>
                </div>
            ) : (
                    ...
                    {Object.keys(corners).map((key) => (
                        <div className="tool-panel" key={key}>
                            ...
                            <div className="tool-controls">
                                <label>
                                    H: {corners[key].h}px
                                    <input type="range" min={0} max={150} value={corners[key].h} onChange={(e) => updateCorner(key, 'h', Number(e.target.value))} />
                                </label>
                                <label>
                                    V: {corners[key].v}px
                                    <input type="range" min={0} max={150} value={corners[key].v} onChange={(e) => updateCorner(key, 'v', Number(e.target.value))} />
                                </label>
                            </div>
                        </div>
                    ))}
            ...
            <div className="tool-panel">
                ...
                <div style={{ padding: 20, display: 'flex', justifyContent: 'center' }}>
                    <div style={{ width: 180, height: 180, background: 'var(--accent-border)', borderRadius: radiusValue, }} />
                </div>
            </div>
            <div className="tool-panel">
